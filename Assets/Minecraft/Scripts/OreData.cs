...
public class OreData : ScriptableObject
{
    ...
    /// <summary>
    /// percentage of the ore which can be inside the depth range of oreUpperDepth and oreLowerDepth 
    /// with respect to total number of blocks in layer
    /// </summary>
    public float inZonePercentageLayer;
    /// <summary>
